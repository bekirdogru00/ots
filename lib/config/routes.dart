    ...
    switch (settings.name) {
      case '/':
        return MaterialPageRoute(
          builder: (_) =>
              const Placeholder(), // SplashScreen - main.dart'ta tanımlı
        );

      case '/login':
        return MaterialPageRoute(
          builder: (_) =>
              const Placeholder(), // LoginScreen - main.dart'ta tanımlı
        );

      case '/register':
        return MaterialPageRoute(
          builder: (_) =>
              const Placeholder(), // RegisterScreen - main.dart'ta tanımlı
        );

      case '/home':
        return MaterialPageRoute(
          builder: (_) =>
              const Placeholder(), // HomeScreen - main.dart'ta tanımlı
        );
      ...
      case '/new-chat':
        return MaterialPageRoute(
          builder: (_) => const Placeholder(), // NewChatScreen eklenecek
        );

      case '/pomodoro':
        return MaterialPageRoute(
          builder: (_) =>
              const Placeholder(), // PomodoroScreen - main.dart'ta tanımlı
        );
